...
/** Load v1 (Jan 2025) ONET data as a primary catalog (no prior/delta) */
export function loadOnetCatalogV1(): OnetCatalogRole[] {
  if (cachedCatalogV1) return cachedCatalogV1;
